...
func DevicesDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"devices": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"port_overrides": schema.ListNestedAttribute{
							...
							MarkdownDescription: "Settings overrides for specific switch ports.",
						},
					},
				...
				MarkdownDescription: "The list of Devices associated with the site.",
			},
			"site": schema.StringAttribute{
				Optional:            true,
				Description:         "The name of the site the Devices are associated with.",
				MarkdownDescription: "The name of the site the Devices are associated with.",
			},
		},
	}
}
